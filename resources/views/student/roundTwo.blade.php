                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    <form id="answerForm" method="POST" action="{{ route('submit.answers.roundTwo') }}">
                                        @csrf
                                    ...
                                    @endforeach
                                        ...
                                        <div class="text-center mt-4">
                                            <button type="submit" class="submit-btn bg-blue-500 text-white font-semibold py-2 px-6 rounded-md hover:bg-blue-600 transition duration-200">
                                                Submit Answer
                                            </button>
                                        </div>
                                    </form>
